...
xit('returns taskPosition 1 if second test fails', function() {
  var files = [
...
xit('returns taskPosition 3 if fourth test fails', function() {
  var files = [
...
xit('returns taskPosition 0 if any of the first tests fail', function () {
    var files = [
...
xit('returns the taskPosition at the correct point with arrays of tests', function () {
  var files = [
